...
function Contact({display}) {
  ...
  return (
    <>
    <SignedIn>
    <div style={{display:display}} className={`contact-inner flex flex-end justify-center items-center ${gradientStyles} shadow-2xl rounded-md w-64 h-96 absolute mt-4 ml-56`}>
       ...
       <SignedOut>
       <div style={{display:display}} className={`contact-inner flex flex-end justify-center items-center ${gradientStyles} shadow-2xl rounded-md w-64 h-96 absolute mt-4 ml-96`}>
           <div className='flex justify-center flex-col'>
             <form onSubmit={handleSubmit}>
               <Box sx={{width: 500,maxWidth: '100%', marginTop:2, paddingLeft:2, paddingRight:2, textAlign:'center'}}>
                 <div className='font-Roboto tracking-tighter text-sm font-bold'>Leave a message !</div>
